...
The calibration tool originates from an implementation of this paper <span style="color:orange">Leveraging IoT Data Stream for Near-Real-Time Calibration of City-Scale Microscopic Traffic Simulation</span>. A preprint version of the paper can be downloaded at [link](https://arxiv.org/pdf/2210.17315.pdf).
